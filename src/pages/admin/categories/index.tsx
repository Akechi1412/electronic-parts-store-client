...
import { CategoryRow } from '@/components/admin';
...
export default function AdminCategoriesPage() {
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        const { data } = await categoriesApi.getPerPage({
          page: currentPage,
          limit,
          nameFilter,
        });
    ...
    <Auth isAdminPage>
      <div className="mt-7">
        <div className="flex justify-between items-end">
          <h2 className="text-[28px] font-medium capitalize">Danh sách danh mục</h2>
          ...
          <AddButton title="Thêm danh mục" href="/admin/categories/new" />
        </div>
        <div className="my-6">
        ...
        <div className="mt-6 flex items-end justify-between">
          <p>
            Đang hiển thị {categoriesData.length} trên tổng số {totalRows}
          </p>
          <ReactPaginate
